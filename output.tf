...
output "instance_external_ips" {
  value = {
    vm1 = "http://${google_compute_instance.pbc-instance.network_interface[0].access_config[0].nat_ip}"
    vm2 = "http://${google_compute_instance.pbc-instance-brazil.network_interface[0].access_config[0].nat_ip}"
    vm3 = "http://${google_compute_instance.pbc-instance-toyko.network_interface[0].access_config[0].nat_ip}"
  }
